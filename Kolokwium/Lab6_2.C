...
void Lab6_2(){
  ...
  TF1 *g = new TF1("g","[0]",xmin,xmax);
  Double_t a = 0.;
  Double_t b = c*TMath::Exp(xmax);
  g->FixParameter(0,b);
  ...
  cout<<"Stala ograniczajaca: "<<b<<endl;
  ...
  for(int ii=0; ii<N; ii++){
    ...
    Double_t x = (xmax - xmin)*gRandom->Uniform(0.,1.);
  ...
  leg2->AddEntry(pts_accepted,"Zaakceptowane","p");
  leg2->AddEntry(pts_rejected,"Odrzucone","p");
  leg2->Draw("same");
